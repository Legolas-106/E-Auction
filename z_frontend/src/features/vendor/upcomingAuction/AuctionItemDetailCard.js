...
const AuctionItemDetialCard = ({ item, setSelecteditem, onSubmit }) => {
  ...
  console.log(item);
  useEffect(() => {
    // Initialize formData with item data
    setFormData({
      ...
      auctionlotDetails: item.auctionLotDetails?.map(lotItem => ({
        ...lotItem,
...
export default AuctionItemDetialCard;